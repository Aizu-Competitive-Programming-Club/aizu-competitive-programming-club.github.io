...
その後に、この `a*b` の偶奇判定をすればよいわけですが、これを考える上では偶数と奇数とはどのようなことか？ということを考えなければなりません。
...
先程の問題が出題されたコンテストサイトである **AtCoder** は、日本の競技プログラマーであればコンテストに参加したことがあると言って良いほど有名なサイトです。週末の 21:00 からほぼ毎週開催されている Beginner Contest には、国内外から一万人程度の参加者が集まっています。

AtCoder のコンテストに参加することによって、**レーティング**が計算されます。このレーティングは競技プログラミングの実力を示す一つの指標であり、これを上げると名前の色が変わる等、この値自体が競技へのモチベーションの一つとなるようになっています。
...
しかし、初心者のうちは最もベーシックかつ効果的な手法である**問題を解きつつコンテストに参加し、復習をする**ことをおすすめします。競技プログラミング部では、これを活動の主軸に据えています。

では、実際に過去問を解いてみましょう！[次の項](/beginner/getting-started)では、競技プログラミングの問題を解きながらプログラミングの基礎を学ぶといった形で競技プログラミングに入門していきます。
